...
<!--                       <input name="userEmail" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..."> -->
<!--                     </div> -->
<!--                     <div class="form-group"> -->
            ...
            <div class="row">
              <div class="col-sm-5 col-sm-offset-4 mb-sm-40">
                ...
                <form class="form" method="post"action="login">
                  <div class="form-group">
                    <input class="form-control" id="username" type="email" name="userEmail" placeholder="Username"/>
                  </div>
                  <div class="form-group">
