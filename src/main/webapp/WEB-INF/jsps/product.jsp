		...
		<div
			...
			<div class="col-first">
				...
				<nav class="d-flex align-items-center">
					<a href="/">Home<span class="lnr lnr-arrow-right"></span></a> <a
						href="#">Shop<span class="lnr lnr-arrow-right"></span></a> <a
						href="/onepro/${item.idProduct}">product-details</a>
				</nav>
			</div>
		</div>
	</div>
				...
				<div class="s_Product_carousel">
					<c:forEach items="${item.getImages()}" var="Image">
						<div class="single-prd-item">
							<img class="img-fluid" src="${Image.getImagePath()}"
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					...
					<form method="post" action="/addtocart">
						<input type="hidden" name="pid" value="${item.idProduct}">
						...
						<div class="card_area d-flex align-items-center">
							<button type="submit" class="primary-btn" href="">Add to
								Cart</button>
				...
				<div class="table-responsive">
					<table class="table">
						<tbody>
							...
							<tr>
								<td>${item.productcol1}</td>
							</tr>
							<tr>
								<td>${item.productcol2}</td>
							</tr>
							<tr>
								<td>${item.productcol3}</td>
							</tr>
							<tr>
						...
						<div class="review_box">
							...
							<form class="row contact_form" action="contact_process.php"
								...
								<div class="col-md-12">
									<div class="form-group">
										<textarea class="form-control" name="message" id="message"
											rows="1" placeholder="Review" onfocus="this.placeholder = ''"
...
function addtoshop(){
	...
	$.ajax({
		url : 'http://localhost:80/addtoshop/'+user+'/'+pro,
		type : "GET",
