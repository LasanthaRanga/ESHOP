...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="shop/img/fav.png">
	<!-- Author Meta -->
	...
	<link rel="stylesheet" href="../shop/css/themify-icons.css">
	<link rel="stylesheet" href="../shop/css/bootstrap.css">
	<link rel="stylesheet" href="../shop/css/owl.carousel.css">
	<link rel="stylesheet" href="../shop/css/nice-select.css">
	<link rel="stylesheet" href="../shop/css/nouislider.min.css">
	<link rel="stylesheet" href="../shop/css/ion.rangeSlider.css" />
	<link rel="stylesheet" href="../shop/css/ion.rangeSlider.skinFlat.css" />
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="/"><img src="../shop/img/logo.png" alt=""></a>
...
<!-- 							
							...
							<c:if test="${sessionScope.user==null}">Login</c:if>
							</a>
							<ul class="dropdown-menu">		
									...
									<li class="nav-item"><a class="nav-link" href="/singup">Register</a></li>
									</c:if>
							</ul>
